...
def push_company_size_MQLs(df_final_MQLs):
    ...
    #MQL cap
#     df_final_MQLs_Company_Size = df_final_MQLs_Company_Size.sort_values('Number of Employees',ascending=False).head(8) 
...
#     push_mqls_to_hubspot(email_list, reason_list, MRR_list, mixpanel_distinct_id_list, last_seen_list, 'company_size')
    push_leads_to_intercom(email_list, 'company_size')
